...
import { X, Bed, Trash2, AlertTriangle, Users, Building2 } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4 animate-in fade-in duration-150">
      <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-6 border border-slate-100 overflow-hidden">
        ...
        <div className="mt-4 relative rounded-2xl overflow-hidden border border-slate-200 shadow-2xs h-36">
          <img
            src={roomImage}
